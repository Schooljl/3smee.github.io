(async () => {
    ...
    const sounds = {
        "Mars": new Audio("my_sounds/wiebel-wiebel.mp3"),
        "Snickers": new Audio("my_sounds/watdoejegek.mp3"),
        "Milkyway": new Audio("my_sounds/goedgedaan.mp3")
        
    };

    const images = {
        "Mars": "my_images/eenbeenstaan.png",
        "Snickers": "my_images/handenophoofd.png",
        "Milkyway": "my_images/handenwijd.png",
        "Neutral": "my_images/normaal.png"
    };
